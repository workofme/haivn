...
$db = new Database;
$view = $_POST['view'];
$views = $db->total('SELECT * FROM `post`');
...
if(isset($_POST['limit'])  && isset($_POST['start'])){
    ...
    $plus_view = $db->updateview("UPDATE `post` SET `views` = '{$views['views']}' + 1");
    ...
    <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7">
        <div class="view">
            ...
            <p>
                ...
                <a class="fas fa-comments commnets" href="?views=comment&query=<?php echo $row['id'] ?>"> &nbsp; 22 &nbsp;</a>
                ...
                if($check_like > 0){
                    $get_like = $db->total("SELECT * FROM `likes` WHERE `post` = '{$row['id']}' AND `id_thanhvien_like` = '{$get_user['id']}'  AND `id_thanhvien_post` = '{$row['id_thanhvien']}' ");
